...
type BaseModuleContext interface {
	...
	OtherModuleSubDir(m blueprint.ModuleOrProxy) string
	...
	// It is intended for use inside the visit functions of Visit* and WalkDeps.
	OtherModuleType(m blueprint.ModuleOrProxy) string
	...
	OtherModuleIsAutoGenerated(m blueprint.ModuleOrProxy) bool
...
func EqualModules(m1, m2 blueprint.ModuleOrProxy) bool {
	return blueprint.EqualModules(m1, m2)
}

func (b *baseModuleContext) OtherModuleName(m blueprint.ModuleOrProxy) string {
	return b.bp.OtherModuleName(m)
}
func (b *baseModuleContext) OtherModuleDir(m blueprint.ModuleOrProxy) string {
	return b.bp.OtherModuleDir(m)
}
func (b *baseModuleContext) OtherModuleErrorf(m blueprint.ModuleOrProxy, fmt string, args ...interface{}) {
	b.bp.OtherModuleErrorf(m, fmt, args...)
}
func (b *baseModuleContext) OtherModuleDependencyTag(m blueprint.ModuleOrProxy) blueprint.DependencyTag {
	return b.bp.OtherModuleDependencyTag(m)
}
func (b *baseModuleContext) OtherModuleSubDir(m blueprint.ModuleOrProxy) string {
...
func (b *baseModuleContext) OtherModuleType(m blueprint.ModuleOrProxy) string {
	return b.bp.OtherModuleType(m)
}

func (b *baseModuleContext) otherModuleProvider(m blueprint.ModuleOrProxy, provider blueprint.AnyProviderKey) (any, bool) {
...
func (b *baseModuleContext) OtherModuleIsAutoGenerated(m blueprint.ModuleOrProxy) bool {
...
func (b *baseModuleContext) IsFinalModule(module blueprint.ModuleOrProxy) bool {
...
func (b *baseModuleContext) GetPathString(skipFirst bool) string {
	...
	var walkPath []blueprint.ModuleOrProxy
	if b.walkPath != nil {
