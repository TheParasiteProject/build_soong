...
func TestPartialCompile(t *testing.T) {
	...
	tests := []struct {
		...
		{"all", true, partialCompileFlags{}.updateUseD8(true).updateDisableStubValidation(true).updateEnableIncJavac(true).updateEnableIncKotlin(false).updateEnableIncD8(true).updateEnableIncKotlinJavaDep(true).updateEnableIncD8OutsidePlatform(true)},
